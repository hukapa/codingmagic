...
<section class="home">
    <div class="img-parallax" style="background-image: url(/CodingMagic-LandingPage.jpg);">
        <nav class={scroll < 50 ? "nav" : "nav affix"}>
            <div class="container" >
              <div class="logo">
                <a href="#" >Coding Magic</a>
              </div>
              ...
              <button class:active={MenuActive} class="navTrigger" on:click={toggleMenu}>
                <i></i>
                <i></i>
                <i></i>
              </button>
...
<section class="asd">
    <div class="img-parallax" style=" background-image: url(/CodingMagic-1.jpg);">
